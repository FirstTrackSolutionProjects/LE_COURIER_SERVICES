...
//             <h2 className="text-xl font-bold mb-4 hover:underline">ADI COURIER SERVICES</h2>
...
//             <p className="mt-3 mb-8 md:-mb-4">Email:  info@adicourier.com </p>
//           </div>
    ...
    <>
      <footer className="bg-red-600 font-bold text-white p-8">
        <div className="container mx-auto px-2">
          ...
          <div className="mt-8 text-center">
            <p>&copy; {new Date().getFullYear()} Developed by First Track Solution Technologies.</p>
          </div>
        </div>
      </footer>
    </>
